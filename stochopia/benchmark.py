"""Stochopia research benchmark protocol.
...
ACTION_SCHEMA_VERSION = "stochopia.environment.action-schema.v1"
...
class ProductDomainSpec:
    ...
    version: str = "stochopia.product-domain.csi-action-contract.v1"
...
def client_contract_pass(
    ...
    *,
    ...
    Mirrors stochopia.products.ClientProfile.would_buy but on the continuous loss
...
class LongHorizonEnvironment:
    ...
    async def consult(self, role: str, message: str, draft: dict | None = None) -> dict:
        ...
        request = RoleRequest(
            ...
            payload=payload,
            protocol_version=self.env_agents[role].spec.protocol_version,
            state_version=self.state_version,
            recipient=role,
        )
    ...
    async def query_client_llm(self, topic: str) -> dict:
        ...
        request = RoleRequest(
            ...
            protocol_version=self.env_agents["client"].spec.protocol_version,
            state_version=self.state_version,
            recipient="client",
        )
