"""External-agent adapters and rollout runner for the Stochopia v3 environment.
...
from .core import StochopiaStructurerEnv
...
AGENT_REQUEST_SCHEMA = "stochopia.agent-request.v1"
AGENT_RUN_SCHEMA = "stochopia.agent-run.v1"
AGENT_PROMPT_VERSION = "stochopia.agent-prompt.v1"
...
async def run_agent_episode(
    ...
    *,
    ...
    if not isinstance(environment, StochopiaStructurerEnv):
        raise TypeError("environment must be a StochopiaStructurerEnv")
    if (
